...
export default function LoginPage() {
  ...
  // Already signed in (e.g. back button, bookmark) - a login form under a header
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-1 flex-col gap-10 px-6 py-10 sm:px-10">
      <PageHeader title="Log in" subtitle="Sign in to save and resume your documents." backLink={{ href: "/", label: "Back to documents" }} />
      ...
      {status !== "authenticated" && (
        ...
        >
          ...
          >
            {isSubmitting ? <ArrowsClockwise size={18} weight="bold" className="animate-spin" /> : "Log in"}
          </button>
